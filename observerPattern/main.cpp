...
int main() {
    ...
    // створюємо об'єкти хабу та пристроїв
    Hub hub;
    AC ac;
    Display display;
    ...
    // змінюємо температуру (сповіщення отримають обидва пристрої)
    hub.setTemp(28);

    // відключаємо кондиціонер
    hub.remove(&ac);

    // змінюємо температуру ще раз (сповіщення отримає тільки дисплей)
    hub.setTemp(20);
